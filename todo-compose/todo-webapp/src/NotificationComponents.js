...
export class NotificationTable extends React.Component {
  constructor(props) {
    ...
    this.notification_endpoint = "http://localhost:80/noti/";
  }
  ...
  componentDidMount() {
    this.timerID = setInterval(() => this.refreshBadge(), 3000);
  }
  ...
  render() {
    ...
    for (var i = 0; i < n; i++) {
      ...
      rows.push(<NotificationRow notification={notification} key={i} />);
    }
